            ...
            <nav class="col-10">
                ...
                <section>
                    <nav class="show-admin">
                        <h2>Sản phẩm</h2>
                        <a href="?page=sp&product=insertProduct" class="btn btn-primary">Thêm mới</a>
                        <table border="1" style="text-align:center">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-warning" href="?page=sp&product=updateProduct&id=<?=$product['id']?>">Sửa</a>
                                        <a class="btn btn-danger" onclick="return deletePro()" href="?page=sp&product=deleteProduct&id=<?=$product['id']?>">Xóa</a>
                                    </td>
                                </tr>
                                <?php endforeach ?>
                            </tbody>
