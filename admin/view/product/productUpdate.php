                    ...
                    <nav class="show-admin">
                        ...
                        <form action="" method="post"  enctype="multipart/form-data">
                            ...
                            <div>
                                ...
                                <img src="<?=$oneProduct['image']?>" alt="" width="40%">
                            </div>
                            <div>
                                <label for="">Giá</label>
                            ...
                            <div>
                                ...
                                <input type="text" class="form-control" name="detail" value="<?=$oneProduct['detail']?>">
                            </div>
                            <div>
                                <input type="submit" name="btn_submit" value="Sửa" class="btn btn-primary">
                                <a href="?page=sp&product=listProduct" class="btn btn-danger">Hủy</a>
                            </div>
                        </form>
                    </nav>
                </section>
